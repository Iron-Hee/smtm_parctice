...
class StrategyBuyAndHoldTests(unittest.TestCase):
  ...
  def test_initialize_update_initial_balance(self):
    ...
    self.assertEqual(bnh.is_initialized, False)
    ...
    self.assertEqual(bnh.is_initialized, True)
  ...
  def test_update_trading_info_ignore_info_when_not_yet_initialized(self):
    bnh = StrategyBuyAndHold()
    bnh.update_trading_info("mango")
  ...
  def test_update_result_remove_from_waiting_requests(self):
    ...
    bnh.initialize(100000, 10)
    self.assertEqual(bnh.balance, 100000)
    bnh.waiting_requests["orange"] = "orange_request"
  ...
  def test_get_request_return_None_when_data_is_invalid(self):
    bnh = StrategyBuyAndHold()
    bnh.initialize(100, 10)
    dummy_info = {}
  ...
  def test_get_request_return_turn_over_when_balance_is_smaller_than_min_price_at_simulation(self):
    bnh = StrategyBuyAndHold()
